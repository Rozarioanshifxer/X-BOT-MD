...
const SESSION_ID = process.env.SESSION_ID || "X-BOT-MD:JacobsAbide";
...
const BOT_INFO = process.env.BOT_INFO || " ᴀɴsʜɪғ xᴇʀ-MD; ᴀɴsʜɪғ xᴇʀ;https://i.imgur.com/r3GZeiX.jpeg";
...
const STICKER_DATA = process.env.STICKER_DATA || " ᴀɴsʜɪғ xᴇʀ MD; ᴀɴsʜɪғ xᴇʀ";
